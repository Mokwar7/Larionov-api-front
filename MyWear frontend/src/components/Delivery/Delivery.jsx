            ...
            <div className="contacts__container">
                ...
                <div className="contacts__section">
                    <div className="contacts__block">
                        ...
                        <p className="contacts__txt">Вы можете оплатить 50% от стоимости заказа, а остальное после получения в Москве или перед отправкой в регионы. Так Вы сможете сделать заказ, даже если у Вас нет всей суммы на руках</p>
                    </div>
                    <div className="contacts__block">
