...
function Card({ isLogged, cart, getCart, addToCart, removeCountFromCart, addCountToCart, removeFromCart }) {
    ...
    function handleClickSize(e) {
        ...
        alreadyIncart.find(arr => arr.article == goodInfo.article) && alreadyIncart.find(arr => arr.size == e.target.value) ?
        setInCart(alreadyIncart.find(arr => arr.size == e.target.value).count) :
        setInCart(0)
                ...
                <form action="" className="card__form" name="cardForm">
                    <div className="card__info">
                        <div className="card__header">
                            ...
                            <p className="card__price">{price}₽ / сутки</p>
                        </div>
