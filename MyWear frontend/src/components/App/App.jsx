...
function App() {
  ...
  function auth() {
    fetch('http://158.160.23.164:3000/users/me', {
      ...
      .then((res) => {
        console.log('asadsaflksadflksjadfklsad')
  ...
  return (
    <CurrentUserContext.Provider value={currentUser}>
      ...
      <Routes>
        ...
        <Route path="/profile" element={<ProtectedRouteElement element={Profile} handleExit={handleExit} handleUpdateName={handleUpdateName} handleUpdateTg={handleUpdateTg} />} />
