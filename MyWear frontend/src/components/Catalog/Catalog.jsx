...
function Catalog() {
    ...
    function handleChangeSearch(e) {
        ...
        arrGoods.forEach((item) => {
            if ((item.brand.toLowerCase() + ' ' + item.name.toLowerCase()).includes(search.toLowerCase())) {
                newArr.push(item)
    ...
    return (
        <>
            ...
            <form action="" className="search">
                <input type="text" className="search__input" required min='1' step='any' placeholder='Поиск' value={search} onChange={handleChangeSearch} onFocus={e => setSearch('')} />
