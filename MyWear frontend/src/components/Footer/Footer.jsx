        ...
        <footer className='footer'>
            <div className="footer__container">
                ...
                <nav className="footer__section">
                    ...
                    <NavLink className="footer__link hover7" to='https://www.wildberries.ru/seller/4139420'>Политика конфидециальности</NavLink>
                    <NavLink className="footer__link hover7" to='https://www.wildberries.ru/seller/4139420'>Пользовательское соглашение</NavLink>
                    <NavLink className="footer__link hover7" to='https://www.wildberries.ru/seller/4139420'>Куки на нашем сайте</NavLink>
                </nav>
                <nav className="footer__section">
